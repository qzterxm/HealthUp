namespace DataAccess.DataAccess
{
    public static class SqlQueries
    {
        ...
        public const string UpdateUser = @"UPDATE Users SET Email = @Email, UserName = @UserName, Password = @Password, Gender = @Gender, Age = @Age, DateOfBirth = @DateOfBirth, Country = @Country,  PhoneNumber = @PhoneNumber,UserRole = @UserRole, ProfilePictureUrl = @ProfilePictureUrl WHERE Id = @Id;";
        ...
        public const string AddUserFile = "INSERT INTO UserFiles (Id, UserId, FileName, ContentType, FileData, UploadedAt, VisitId) -- <--- Додано колонку\nVALUES (@Id, @UserId, @FileName, @ContentType, @FileData, @UploadedAt, @VisitId); -- <--- Додано параметр";
